...
import { webstreamrExtractor } from './webstreamr.js';
...
function extractLinksWithMetadata(html, mediaType, season, episode) {
    ...
    const isValidStreamLink = (href, rawText) => {
        ...
        // 1. URL BLACKLIST: Drop internal, social, and broken template links
        ...
        // 2. TEXT BLACKLIST: Drop specific qualities, packs, and watch buttons
        ...
        // KEEP the link ONLY if it passes BOTH blacklists
    ...
    if (mediaType === 'movie') {
        ...
        if (startMatch) {
            ...
            // Added word boundaries \b to prevent random ID collisions
